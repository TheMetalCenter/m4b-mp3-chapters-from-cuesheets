...
2. Obtain a .cue with desired chapter info
	- via a tracklist from mp3tag or pause detection by mp3directcut-
3. Edit .cue to add chapter info
4. Convert .cue to ffmetadata
5. Combine ffmetadata with mp3/mp4 file
