...
1. Merge multiple files to a single file mp3/mp4 file
2. Obtain a .cue file (from a tracklist file generated by mp3tag or pause detection by mp3directcut)
3. Covert .cue file to ffmetadata file
